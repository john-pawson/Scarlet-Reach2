...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_SILVER_BLOOD = span_info("My blood is blessed by the gods with silver, burning any deadites that dare try and feast on it. It will not protect me from their curse, however."),
